...
{
	local SteamStatsAndAchievementsBase SteamStatsAndAchievements;
...
//if _RO_
	if ( Level.NetMode != NM_Client && Level.ZoneTag != 'ROEntry' )
	{
...
// if _RO_
    GIPropDescText(9)="Enable this option to send game statistics to the Red Orchestra global stats server"
// else
