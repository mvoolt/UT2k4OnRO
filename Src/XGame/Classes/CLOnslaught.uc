...
defaultproperties
{
     ...
     Matches(0)=UT2K4MatchInfo'XGame.CLOnslaught.ONS1'
     Matches(1)=UT2K4MatchInfo'XGame.CLOnslaught.ONS2'
     Matches(2)=UT2K4MatchInfo'XGame.CLOnslaught.ONS3'
     Matches(3)=UT2K4MatchInfo'XGame.CLOnslaught.ONS4'
     Matches(4)=UT2K4MatchInfo'XGame.CLOnslaught.ONS5'
     Matches(5)=UT2K4MatchInfo'XGame.CLOnslaught.ONS6'
}
