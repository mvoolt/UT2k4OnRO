//=============================================================================
// KrivoiPlaneController
//=============================================================================
// A special actor to control spawning the planes on Krivoi Rog map
//=============================================================================
...
class KrivoiPlaneController extends Actor
	placeable;

var(KrivoiPlaneController) int SecondsTimeToTrigger;
var(KrivoiPlaneController) class<Emitter> EmitterToSpawn;
...
simulated event Timer()
{
    ...
    if( PC != none )
    {
        ...
        if( GRI != none && GRI.bMatchHasBegun)
        {
            ...
            {
                Spawn(EmitterToSpawn,,,Location,Rotation);
                SetTimer(0.0, false);
            }
        }
    }
