...
DefaultProperties
{
    ...
    ImpactDamageSounds(0) = Sound'Vehicle_Engines.bottom_out'
	...
	ExplosionSounds(0)=sound'Vehicle_Weapons.vehicle_explode01'
	ExplosionSounds(1)=sound'Vehicle_Weapons.vehicle_explode02'
