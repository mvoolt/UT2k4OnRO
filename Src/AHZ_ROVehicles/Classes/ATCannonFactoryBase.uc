...
// ATCannonFactoryBase
//=============================================================================
// Base Factory for Anti-tank cannons
//=============================================================================
...
class ATCannonFactoryBase extends ROVehicleFactory
    abstract;
...
{
    local array<ATCannonFactoryBase> GunFactories;
    local int i;
    local ATCannonFactoryBase GunFactory;
    ...
    foreach DynamicActors(class'ATCannonFactoryBase', GunFactory)
	{
    ...
    // wants to spawn and how many total cannons thier are in the array.
	if( MaxToSpawn > 0 )
	{
