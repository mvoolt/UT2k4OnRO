...
class G43ScopedAttachment extends ROWeaponAttachment;

defaultproperties
{
    Mesh=mesh'Weapons3rd_anm.g43scope'
    menuImage=Texture'InterfaceArt_tex.Menu_weapons.g43scope' // Replaceme
    MenuDescription="Semi-automatic rifle, used a 10-round mag with good accuracy and stopping power. Many fitted with a sniper scope as factory-standard."
