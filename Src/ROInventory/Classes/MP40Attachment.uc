...
class MP40Attachment extends ROWeaponAttachment;

defaultproperties
{
    menuImage=Texture'InterfaceArt_tex.Menu_weapons.mp40'
    MenuDescription="MP40: standard German sub-machine gun, firing the light 9mm Parabellum round. 32-round box mag, firing at 500rpm. Accurate out to about 200 metres."

/* RO TRACER AND SHELL VARIABLES */
  	mMuzFlashClass=class'ROEffects.MuzzleFlash3rdMP'
  	ROShellCaseClass=class'ROAmmo.RO3rdShellEject9x19mm'

    Mesh=mesh'Weapons3rd_anm.mp40'
    bHeavy=false
    bRapidFire=true
    bAltRapidFire=false
...
// Moving fire anims
	...
	PA_TakeoffAnims(2)=jumpL_takoff_mp40//jumpL_takeoff_mp40
	PA_TakeoffAnims(3)=jumpR_takoff_mp40//jumpR_takeoff_mp40
