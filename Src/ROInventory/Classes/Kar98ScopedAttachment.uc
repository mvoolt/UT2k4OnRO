...
class Kar98ScopedAttachment extends ROWeaponAttachment;
...
defaultproperties
{
	...
	MenuDescription="Sniper version of the Mauser 98K. Bolt-action rifle with sniper scope fitted. Slow-firing, but very accurate. 5-round mag/clip."
    bLoopReloadAnim=true
    Mesh=mesh'Weapons3rd_anm.kar98_scoped'
