...
class Kar98Attachment extends ROWeaponAttachment;

defaultproperties
{
    menuImage=Texture'InterfaceArt_tex.Menu_weapons.kar98'
    MenuDescription="Mauser 98K: bolt-action rifle made by the million. Standard German rifle throughout the war, loved for its reliability and accuracy. 5-round mag/clip and bayonet attachment."
    Mesh=mesh'Weapons3rd_anm.kar98'
