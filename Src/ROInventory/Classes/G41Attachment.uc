...
class G41Attachment extends ROWeaponAttachment;

#exec OBJ LOAD FILE=InterfaceArt2_tex.utx

defaultproperties
{
    Mesh=mesh'Weapons3rd_anm.g41'
    menuImage=Texture'InterfaceArt2_tex.Menu_weapons.g41'
    MenuDescription="Semi-automatic rifle, used a 10-round non detachable mag with good accuracy and stopping power."
