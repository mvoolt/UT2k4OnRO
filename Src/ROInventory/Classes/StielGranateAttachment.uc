...
class StielGranateAttachment extends ROWeaponAttachment;
...
defaultproperties
{
    ...
    MenuDescription="Stielhandgranate 39/43: basic German stick-grenade. Works on blast effect. The handle allows it to be thrown a good distance."

	Mesh=Mesh'Weapons3rd_anm.StielHandGranate'
	bHeavy=false
	bRapidFire=false
...
// MergeTODO: Replace these with the right anims
	...
	PA_TurnLeftAnim=stand_turnLhip_binoc//stand_turnLhip_nade
	PA_TurnRightAnim=stand_turnrhip_binoc//stand_turnRhip_nade
...
// Moving fire anims
	PA_MoveStandFire(0)=stand_throw_nade//stand_shootFhip_nade
	PA_MoveStandFire(1)=stand_throw_nade//stand_shootFhip_nade
	PA_MoveStandFire(2)=stand_throw_nade//stand_shootLRhip_nade
	PA_MoveStandFire(3)=stand_throw_nade//stand_shootLRhip_nade
	PA_MoveStandFire(4)=stand_throw_nade//stand_shootFLhip_nade
	PA_MoveStandFire(5)=stand_throw_nade//stand_shootFRhip_nade
	PA_MoveStandFire(6)=stand_throw_nade//stand_shootFRhip_nade
	PA_MoveStandFire(7)=stand_throw_nade//stand_shootFLhip_nade
