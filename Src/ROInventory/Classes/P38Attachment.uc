...
class P38Attachment extends ROWeaponAttachment;

defaultproperties
{
    menuImage=Texture'InterfaceArt_tex.Menu_weapons.p38'
    MenuDescription="Walther P38: automatic pistol designed to replace the Luger. Slightly more accurate. Used an 8-round box mag."
    Mesh=mesh'Weapons3rd_anm.p38'
