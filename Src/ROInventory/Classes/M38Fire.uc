...
// M38Fire
//=============================================================================
// Bullet firing class for the M38 rifle
//=============================================================================
...
class M38Fire extends ROBoltFire;
...
defaultproperties
{
    ...
    //** Projectile firing **//
    ProjectileClass = class'M38Bullet'
    ...
    //** Sounds **//
  	FireSounds(0) = Sound'Inf_Weapons.nagant1891.nagant9138_fire01'
  	FireSounds(1) = Sound'Inf_Weapons.nagant1891.nagant9138_fire02'
  	FireSounds(2) = Sound'Inf_Weapons.nagant1891.nagant9138_fire03'
