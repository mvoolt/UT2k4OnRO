...
class P08LugerAttachment extends ROWeaponAttachment;

defaultproperties
{
    menuImage=Texture'InterfaceArt_tex.Menu_weapons.luger'
    MenuDescription="Parabellum 1908 Luger: famous automatic pistol, widely issued. Complex and only accurate to 50 metres at best, it used an 8-round box mag."
    Mesh=mesh'Weapons3rd_anm.luger'
