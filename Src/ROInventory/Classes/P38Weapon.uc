...
defaultproperties
{
	...
	//** Display **//
    Mesh=mesh'Axis_P38_1st.P-38-Mesh'
    DrawScale=1.0
    DisplayFOV=70
    IronSightDisplayFOV=35
    BobDamping=1.6
    BayonetBoneName=Bayonet
	HighDetailOverlay=Material'Weapons1st_tex.Pistols.p38_S'
	bUseHighDetailOverlayIndex=true
	HighDetailOverlayIndex=2

    //** Weapon Firing **//
    FireModeClass(0)=P38Fire
    FireModeClass(1)=P38MeleeFire
	...
	//** Inventory/Ammo **//
    PickupClass=class'P38Pickup'
    AttachmentClass=class'P38Attachment'
