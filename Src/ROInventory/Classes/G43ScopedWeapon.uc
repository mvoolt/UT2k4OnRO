...
defaultproperties
{
	...
	//** Display **//
    Mesh=mesh'Axis_G43_1st.G43_scoped_mesh'
    DrawScale=1.0
    DisplayFOV=70
    IronSightDisplayFOV=45
    BobDamping=1.6
    LenseMaterialID = 4
	HighDetailOverlay=Material'Weapons1st_tex.Rifles.g43_sniper_s'
	bUseHighDetailOverlayIndex=true
	HighDetailOverlayIndex=2

    //** Weapon Firing **//
    FireModeClass(0)=G43ScopedFire
	...
	//** Inventory/Ammo **//
    PickupClass=class'G43ScopedPickup'
    AttachmentClass=class'G43ScopedAttachment'
	...
	//** 3d Scope **//
  	scopePortalFOV = 7// 4.0x
  	XoffsetScoped = (X=0.0,Y=0.0,Z=0.0)
  	scopePitch= -10
  	scopeYaw= 40
  	scopePortalFOVHigh = 13 // 4.0x
  	IronSightDisplayFOVHigh = 25
