//=============================================================================
// ROGEGunner_Spring_SS
//=============================================================================
// Defines the characteristics of a given role
//=============================================================================

class ROGEGunner_Spring_SS extends ROGE_SpringCamo_SS;
...
defaultproperties
{
	...
	//SecondaryWeapons(2)=(Item=class'ROInventory.ROc96Base',Amount=1)
	...
	InfoText="MG-Schütze-SS - Difficulty: Advanced||Armed with a light machine gun, the MG-Schütze provides the squad with its primary source of firepower.  The LMG can deliver insurmountable damage to the enemy, but careful use is required to avoid overheating or wasting ammunition.  Since the LMG is not a close combat weapon, the MG-Schütze also requires protection from his squad.  With intelligent use, a spotter, and sufficient ammo reserves, the MG-Schütze can keep the enemy at bay almost indefinitely.||Loadout: MG34, P38|* The MG-Schütze can bring the LMG into action more quickly than others as well as handle barrel changes; a leader spotting for him will increase his accuracy."
