//-----------------------------------------------------------
//   VehicleMGEmitterUC - Ambient Emitter class for RO vehicle MGs
//	Muzzle flash and shell ejection
//-----------------------------------------------------------
class VehicleMGEmitterUC extends VehicleMGEmitter;
...
defaultproperties
{
    Begin Object Class=MeshEmitter Name=MeshEmitter0
        ...
        MaxParticles=30
        StartLocationOffset=(X=-30.000000,Y=5.000000,Z=0.000000)//(X=-47.000000,Y=5.000000)
