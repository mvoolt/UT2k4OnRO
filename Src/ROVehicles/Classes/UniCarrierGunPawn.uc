...
defaultproperties
{
	...
	DriverPositions(0)=(ViewLocation=(X=0,Y=0,Z=0),ViewFOV=85,PositionMesh=Mesh'allies_carrier_anm.Carrier_mg_int',DriverTransitionAnim=VUC_com_close,TransitionUpAnim=com_open,ViewPitchUpLimit=4000,ViewPitchDownLimit=60000,ViewPositiveYawLimit=10000,ViewNegativeYawLimit=-10000,bDrawOverlays=false,bExposed=false)
	DriverPositions(1)=(ViewLocation=(X=0,Y=0,Z=0),ViewFOV=85,PositionMesh=Mesh'allies_carrier_anm.Carrier_mg_int',DriverTransitionAnim=VUC_com_open,TransitionDownAnim=com_close,ViewPitchUpLimit=4000,ViewPitchDownLimit=60000,ViewPositiveYawLimit=10000,ViewNegativeYawLimit=-10000,bDrawOverlays=false,bExposed=true)
